...
Employee.prototype.render = function () {
  ...
  newCard.style =
    "border-radius: 10px; padding: 15px; margin:10px; width: 250px; height: 1fr; background-color: #222831; display: flex; align-items: center; flex-direction: column;";
  ...
  textInfo.innerHTML = `Name: ${this.fullName} <br>
         ID: ${this.employeeId} <br>
         Department: ${this.department} <br> 
         Level: ${this.level} <br>
         Salary: ${this.salary} <br> `;
  textInfo.style =
    "width: 200px; height: 100px; margin: 10px; color: white; font-weight: bold";
  ...
  newCard2.style =
    "border-radius: 10px; padding: 15px; margin:10px; width: 170px; height: 1fr; background-color: #222831; display: flex; align-items: center; flex-direction: column;";
  ...
  textInfo2.innerHTML = `Name: ${this.fullName} <br>
         ID: ${this.employeeId} <br>
         Department: ${this.department} <br> 
         Level: ${this.level} <br>
         Salary: ${this.salary} <br> `;
  textInfo2.style =
    "width: 150px; height: 100px; margin: 10px; color: white; font-weight: bold";
